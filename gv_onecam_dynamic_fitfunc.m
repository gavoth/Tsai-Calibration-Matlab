function deviation = gv_onecam_dynamic_fitfunc(calopt, cam, calfixed, cam2d)
...
ncams=3;
calarray=calfixed;
calarray(1:6,cam)=calopt(1:6,1);  %calarray=[calfixed, calopt]; %here we assume camera 1 is fixed.  If this changes, it needs to be changed here also.
