function [camParaCalib, varargout] = calib_Tsai(Ximg, Xp3D, camParaknown, imgsize)
...
Tinv = T^(-1);
camParaCalib.R = [r1 r2 r3]'; % r1 r2 and r3 are column vectors
camParaCalib.T = [Tx Ty Tz]';
